...
#ifndef EVENTLOOP_BASE_SERVER_CONNECTIONHANLDERIMPL_H
#define EVENTLOOP_BASE_SERVER_CONNECTIONHANLDERIMPL_H
...
#endif //EVENTLOOP_BASE_SERVER_CONNECTIONHANLDERIMPL_H
