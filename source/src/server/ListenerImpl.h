...
#ifndef EVENTLOOP_BASE_SERVER_LISTENERIMPL_H
#define EVENTLOOP_BASE_SERVER_LISTENERIMPL_H
...
/*            Network::UdpListenerWorkerRouter&
     ...
     /*       const envoy::config::listener::v3::UdpListenerConfig config_;
        ...
        //void validateConfig();
        //void buildUdpListenerWorkerRouter(const Network::Address::Instance& address,uint32_t concurrency);
        ...
        //void checkIpv4CompatAddress(const Network::Address::InstanceConstSharedPtr& address, const envoy::config::core::v3::Address& proto_address);
...
/*        void addListenSocketOptions(const Network::Socket::OptionsSharedPtr& options) {
       ...
       // std::unique_ptr<FilterChainManagerImpl> filter_chain_manager_;
        ...
        //std::shared_ptr<Server::Configuration::TransportSocketFactoryContextImpl> transport_factory_context_;
...
#endif //EVENTLOOP_BASE_SERVER_LISTENERIMPL_H
