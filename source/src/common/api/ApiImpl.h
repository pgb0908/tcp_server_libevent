...
#ifndef EVENTLOOP_BASE_SERVER_APIIMPL_H
#define EVENTLOOP_BASE_SERVER_APIIMPL_H
 ...
 */
    ...
    public:
        Impl(Thread::ThreadFactory& thread_factory, Event::TimeSystem& time_system, Random::RandomGenerator& random_generator);
...
#endif //EVENTLOOP_BASE_SERVER_APIIMPL_H
