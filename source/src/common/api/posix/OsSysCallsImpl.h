...
#ifndef EVENTLOOP_BASE_SERVER_OSSYSCALLSIMPL_H
#define EVENTLOOP_BASE_SERVER_OSSYSCALLSIMPL_H

#include "include/api/OsSysCalls.h"
...
#endif //EVENTLOOP_BASE_SERVER_OSSYSCALLSIMPL_H
