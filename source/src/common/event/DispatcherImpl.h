...
#ifndef EVENTLOOP_BASE_SERVER_DISPATCHERIMPL_H
#define EVENTLOOP_BASE_SERVER_DISPATCHERIMPL_H
...
/*        class WatchdogRegistration {
        ...
        std::list <DispatcherThreadDeletableConstPtr>
                deletables_in_dispatcher_thread_
        ABSL_GUARDED_BY(thread_local_deletable_lock_);
...
#endif //EVENTLOOP_BASE_SERVER_DISPATCHERIMPL_H
