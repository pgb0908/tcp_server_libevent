...
#ifndef EVENTLOOP_BASE_SERVER_SOCKETOPTIONIMPL_H
#define EVENTLOOP_BASE_SERVER_SOCKETOPTIONIMPL_H
...
#define ENVOY_ATTACH_REUSEPORT_CBPF Network::SocketOptionName()
    ...
    class SocketOptionImpl : public Socket::Option{
    public:
        SocketOptionImpl(SocketState in_state,
...
#endif //EVENTLOOP_BASE_SERVER_SOCKETOPTIONIMPL_H
