...
#include "src/common/common/Statusor.h"
 ...
 */
    ...
    public:
        ...
        virtual void processPacket(Address::InstanceConstSharedPtr local_address,
                                   ...
                                   Buffer::InstancePtr buffer, MonotonicTime receive_time) =0;
         ...
         */
        virtual uint64_t maxDatagramSize() const =0;
 ...
 */
    ...
    public:
        ...
        //static Address::InstanceConstSharedPtr protobufAddressToAddress(const envoy::config::core::v3::Address& proto_address);
         ...
         */
        //static void addressToProtobufAddress(const Address::Instance& address, envoy::config::core::v3::Address& proto_address);
