...
#ifndef EVENTLOOP_BASE_SERVER_BUFFERIMPL_H
#define EVENTLOOP_BASE_SERVER_BUFFERIMPL_H
...
#include "src/common/common/NonCopyable.h"
    ...
    public:
        ...
        template <bool SafeCommit = true> bool commit(const Reservation& reservation) {
            if constexpr (SafeCommit) {
                ...
                //ASSERT(static_cast<const uint8_t*>(reservation.mem_) == base_ + reservable_ &&reservable_ + reservation.len_ <= capacity_);
            }
 ...
 */
    ...
    public:
        ...
        void setWatermarks(uint32_t, uint32_t) override {
            //ASSERT(false, "watermarks not implemented.");
        }
    ...
    private:
        ...
        struct OwnedImplReservationSlicesOwner : public ReservationSlicesOwner {
            virtual absl::Span<Slice::SizedStorage> ownedStorages() =0;
        };
...
#endif //EVENTLOOP_BASE_SERVER_BUFFERIMPL_H
