...
#ifndef LIBEVENT_TEST1_IOERROR_H
#define LIBEVENT_TEST1_IOERROR_H
 ...
 */
    ...
    public:
        ...
        virtual IoErrorCode getErrorCode() const = 0;
        virtual std::string getErrorDetails() const = 0;
        virtual int getSystemErrorCode() const = 0;
    };
...
#endif //LIBEVENT_TEST1_IOERROR_H
