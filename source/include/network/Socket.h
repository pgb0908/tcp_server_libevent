 ...
 */
    ...
    public:
         ...
         */
        virtual const Address::InstanceConstSharedPtr& directRemoteAddress() const = 0;
         ...
         **/
        virtual absl::optional<uint64_t> connectionID() const = 0;

        /**
         * @return the name of the network interface used by local end of the connection, or unset if not
         *available.
         **/
        virtual absl::optional<absl::string_view> interfaceName() const = 0;
    ...
    public:
         ...
         */
        virtual void setLocalAddress(const Address::InstanceConstSharedPtr& local_address) = 0;
         ...
         * @param local_address the new local address.
         */
        virtual void restoreLocalAddress(const Address::InstanceConstSharedPtr& local_address) = 0;

        /**
         * Set the remote address of the socket.
         */
        virtual void setRemoteAddress(const Address::InstanceConstSharedPtr& remote_address) = 0;

        /**
         * @param SNI value requested.
         */
        virtual void setRequestedServerName(const absl::string_view requested_server_name) = 0;
         ...
         */
        virtual void setJA3Hash(const absl::string_view ja3_hash) = 0;
    };
 ...
 */
    ...
    public:
         ...
         */
        virtual absl::optional<Address::IpVersion> ipVersion() const = 0;
         ...
         */
        virtual Api::SysCallIntResult bind(const Address::InstanceConstSharedPtr address) = 0;
         ...
         *   is successful, errno_ shouldn't be used.
         */
        virtual Api::SysCallIntResult connect(const Address::InstanceConstSharedPtr address) = 0;
         ...
         */
        virtual Api::SysCallIntResult setBlockingForTest(bool blocking) = 0;
