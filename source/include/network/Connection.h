...
#ifndef EVENTLOOP_BASE_SERVER_CONNECTION_H
#define EVENTLOOP_BASE_SERVER_CONNECTION_H
...
/*        virtual ConnectionInfoSetter& connectionInfoSetter() = 0;
       ...
       // virtual const ConnectionSocket::OptionsSharedPtr& socketOptions() const = 0;
         ...
         *  returned.
         */
        virtual absl::optional<std::chrono::milliseconds> lastRoundTripTime() const = 0;
 ...
 */
    ...
    public:
         ...
         */
        //virtual void setTransportSocketConnectTimeout(std::chrono::milliseconds timeout, Stats::Counter& timeout_stat) = 0;
    };
...
#endif //EVENTLOOP_BASE_SERVER_CONNECTION_H
