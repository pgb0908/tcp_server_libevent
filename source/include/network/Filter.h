...
#ifndef EVENTLOOP_BASE_SERVER_FILTER_H
#define EVENTLOOP_BASE_SERVER_FILTER_H
 ...
 */
    ...
    public:
         ...
         */
        //virtual void setDynamicMetadata(const std::string& name, const ProtobufWkt::Struct& value) = 0;

        /**
         * @return const envoy::config::core::v3::Metadata& the dynamic metadata associated with this
         * connection.
         */
        //virtual envoy::config::core::v3::Metadata& dynamicMetadata() = 0;
        //virtual const envoy::config::core::v3::Metadata& dynamicMetadata() const = 0;

        /**
         * @return Object on which filters can share data on a per-request basis.
         */
        //virtual StreamInfo::FilterState& filterState() = 0;
 ...
 */
    ...
    public:
        ...
        virtual bool matches(Network::ListenerFilterCallbacks& cb) const = 0;
    };
 ...
 */
    ...
    public:
         ...
         * @return status used by the filter manager to manage further filter iteration.
         */
        //virtual FilterStatus onData(Network::ListenerFilterBuffer& buffer) = 0;
 ...
 */
    ...
    public:
         ...
         * connection.
         */
        //virtual const DownstreamTransportSocketFactory& transportSocketFactory() const = 0;
         ...
         */
        virtual std::chrono::milliseconds transportSocketConnectTimeout() const = 0;

        /**
         * const std::vector<FilterFactoryCb>& a list of filters to be used by the new connection.
         */
        virtual const std::vector<FilterFactoryCb>& networkFilterFactories() const = 0;
 ...
 */
    ...
    public:
         ...
         */
        //virtual const FilterChain* findFilterChain(const ConnectionSocket& socket,const StreamInfo::StreamInfo& info) const = 0;
    };
 ...
 */
    ...
    public:
         ...
         */
        virtual UdpListener& udpListener() = 0;
    };
 ...
 */
    ...
    public:
         ...
         * @return status used by the filter manager to manage further filter iteration.
         */
        virtual FilterStatus onData(UdpRecvData& data) = 0;
         ...
         * @return status used by the filter manager to manage further filter iteration.
         */
        virtual FilterStatus onReceiveError(Api::IoError::IoErrorCode error_code) = 0;
 ...
 */
    ...
    public:
         ...
         * @param filter supplies the filter being added.
         */
        virtual void addReadFilter(UdpListenerReadFilterPtr&& filter) = 0;
    };
 ...
 */
    ...
    public:
        ...
        virtual bool createNetworkFilterChain(Connection& connection,
                                              const std::vector<FilterFactoryCb>& filter_factories) = 0;
         ...
         */
        virtual bool createListenerFilterChain(ListenerFilterManager& listener) = 0;
 ...
 */
    ...
    public:
        ...
        virtual const Address::Instance& localAddress() const = 0;
        virtual const Address::Instance& remoteAddress() const = 0;
    };

} // namespace Network

#endif //EVENTLOOP_BASE_SERVER_FILTER_H
