...
#ifndef LIBEVENT_TEST1_IOHANDLER_H
#define LIBEVENT_TEST1_IOHANDLER_H
 ...
 */
    ...
    public:
         ...
         */
        virtual os_fd_t fdDoNotUse() const = 0;

        /**
         * Clean up IoHandle resources
         */
        virtual Api::IoCallUint64Result close() = 0;
        ...
        virtual Api::IoCallUint64Result read(Buffer::Instance& buffer,
                                             absl::optional<uint64_t> max_length) = 0;
         ...
         */
        virtual Api::IoCallUint64Result writev(const Buffer::RawSlice* slices, uint64_t num_slice) = 0;
         ...
         * shouldn't be used.
         */
        virtual Api::IoCallUint64Result write(Buffer::Instance& buffer) = 0;
        ...
        virtual Api::IoCallUint64Result recvmsg(Buffer::RawSlice* slices, const uint64_t num_slice,
                                                uint32_t self_port, RecvMsgOutput& output) = 0;
         ...
         */
        virtual Api::IoCallUint64Result recv(void* buffer, size_t length, int flags) = 0;
         ...
         */
        virtual Api::SysCallIntResult bind(Address::InstanceConstSharedPtr address) = 0;
         ...
         *   is successful, errno_ shouldn't be used.
         */
        virtual Api::SysCallIntResult listen(int backlog) = 0;
         ...
         */
        virtual std::unique_ptr<IoHandle> accept(struct sockaddr* addr, socklen_t* addrlen) = 0;
         ...
         *   is successful, errno_ shouldn't be used.
         */
        virtual Api::SysCallIntResult connect(Address::InstanceConstSharedPtr address) = 0;
        ...
        virtual void initializeFileEvent(Event::Dispatcher& dispatcher, Event::FileReadyCb cb,
                                         Event::FileTriggerType trigger, uint32_t events) = 0;
         ...
         */
        virtual Api::SysCallIntResult shutdown(int how) = 0;
         ...
         */
        virtual absl::optional<std::string> interfaceName() = 0;
    };
...
#endif //LIBEVENT_TEST1_IOHANDLER_H
