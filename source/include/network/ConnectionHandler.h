...
#ifndef EVENTLOOP_BASE_SERVER_CONNECTIONHANDLER_H
#define EVENTLOOP_BASE_SERVER_CONNECTIONHANDLER_H
...
/*        virtual void removeFilterChains(uint64_t listener_tag,
    ...
    public:
         ...
         */
        //virtual BalancedConnectionHandlerOptRef getBalancedHandlerByTag(uint64_t listener_tag, const Network::Address::Instance& address) = 0;
         ...
         * listener doesn't exist or rebalancer doesn't exist.
         */
        //virtual BalancedConnectionHandlerOptRef getBalancedHandlerByAddress(const Network::Address::Instance& address) = 0;
    };
 ...
 */
    ...
    public:
         ...
         * removed.
         */
        virtual UdpListenerCallbacksOptRef getUdpListenerCallbacks(uint64_t listener_tag, const Network::Address::Instance& address) = 0;
    };
...
/*        virtual ConnectionHandler::ActiveUdpListenerPtr
        createActiveUdpListener(Runtime::Loader& runtime, uint32_t worker_index,
                                ...
                                Event::Dispatcher& dispatcher, Network::ListenerConfig& config) = 0;*/
 ...
 */
    ...
    public:
        ...
        findByAddress(const Address::InstanceConstSharedPtr& listen_address) = 0;
    };
...
#endif //EVENTLOOP_BASE_SERVER_CONNECTIONHANDLER_H
