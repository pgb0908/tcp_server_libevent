...
#ifndef EVENTLOOP_BASE_SERVER_RUNTIME_H
#define EVENTLOOP_BASE_SERVER_RUNTIME_H
...
#include "include/ThreadLocal/ThreadLocal.h"
 ...
 */
    ...
    public:
        ...
        public:
             ...
             */
            virtual const EntryMap& values() const = 0;
         ...
         */
        virtual bool deprecatedFeatureEnabled(absl::string_view key, bool default_enabled) const = 0;
        ...
        virtual bool runtimeFeatureEnabled(absl::string_view key) const = 0;
         ...
         */
        virtual bool featureEnabled(absl::string_view key, uint64_t default_value) const = 0;
         ...
         * @return true if the feature is enabled.
         */
        //virtual bool featureEnabled(absl::string_view key, const envoy::type::v3::FractionalPercent& default_value) const = 0;
...
/*        virtual bool featureEnabled(absl::string_view key,
         ...
         */
        virtual ConstStringOptRef get(absl::string_view key) const = 0;
         ...
         */
        virtual uint64_t getInteger(absl::string_view key, uint64_t default_value) const = 0;
         ...
         */
        virtual double getDouble(absl::string_view key, double default_value) const = 0;
         ...
         */
        virtual const std::vector<OverrideLayerConstPtr>& getLayers() const = 0;
    };
...
#endif //EVENTLOOP_BASE_SERVER_RUNTIME_H
