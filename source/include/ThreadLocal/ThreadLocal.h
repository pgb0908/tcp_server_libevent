...
#ifndef EVENTLOOP_BASE_SERVER_THREADLOCAL_H
#define EVENTLOOP_BASE_SERVER_THREADLOCAL_H
 ...
 */
    ...
    public:
         ...
         */
        virtual bool currentThreadRegistered() = 0;
    ...
    protected:
        ...
        virtual void runOnAllThreads(const UpdateCb& update_cb) = 0;
        virtual void runOnAllThreads(const UpdateCb& update_cb, const Event::PostCb& complete_cb) = 0;
 ...
 */
    ...
    public:
         ...
         */
        virtual void registerThread(Event::Dispatcher& dispatcher, bool main_thread) = 0;
...
#endif //EVENTLOOP_BASE_SERVER_THREADLOCAL_H
