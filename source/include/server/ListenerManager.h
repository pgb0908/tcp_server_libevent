...
#ifndef EVENTLOOP_BASE_SERVER_LISTENERMANAGER_H
#define EVENTLOOP_BASE_SERVER_LISTENERMANAGER_H
 ...
 */
    ...
    public:
         ...
         */
        virtual std::string versionInfo() const = 0;
    };
...
/*        virtual LdsApiPtr createLdsApi(const envoy::config::core::v3::ConfigSource& lds_config,
                                       const xds::core::v3::ResourceLocator* lds_resources_locator) = 0;*/
...
/*        virtual Network::SocketSharedPtr createListenSocket(
                ...
                const Network::SocketCreationOptions& creation_options, uint32_t worker_index) = 0;*/
...
/*        virtual std::vector<Network::FilterFactoryCb> createNetworkFilterFactoryList(
                ...
                Server::Configuration::FilterChainFactoryContext& filter_chain_factory_context) = 0;*/
...
/*        virtual Filter::ListenerFilterFactoriesList createListenerFilterFactoryList(
                ...
                Configuration::ListenerFactoryContext& context) = 0;*/
...
/*        virtual DrainManagerPtr
        createDrainManager(envoy::config::listener::v3::Listener::DrainType drain_type) = 0;*/

        /**
         * @return uint64_t a listener tag usable for connection handler tracking.
         */
        virtual uint64_t nextListenerTag() = 0;
...
/*        virtual Filter::TcpListenerFilterConfigProviderManagerImpl*
        getTcpListenerConfigProviderManager() = 0;*/
    };
...
/*        virtual void createLdsApi(const envoy::config::core::v3::ConfigSource& lds_config,
         ...
         */
        virtual void startWorkers(std::function<void()> callback) = 0;
         ...
         */
        virtual void stopListeners(StopListenersType stop_listeners_type) = 0;
         ...
         * state.
         */
        //virtual void beginListenerUpdate() = 0;
...
/*        using FailureStates = std::vector<std::unique_ptr<envoy::admin::v3::UpdateFailureState>>;
        virtual void endListenerUpdate(FailureStates&& failure_states) = 0;*/
         ...
         */
        //virtual ApiListenerOptRef apiListener() = 0;

        /*
         * @return TRUE if the worker has started or FALSE if not.
         */
        virtual bool isWorkerStarted() = 0;
    };
...
#endif //EVENTLOOP_BASE_SERVER_LISTENERMANAGER_H
