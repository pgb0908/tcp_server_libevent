...
#ifndef EVENTLOOP_BASE_SERVER_LIFECYCLENOTIFIER_H
#define EVENTLOOP_BASE_SERVER_LIFECYCLENOTIFIER_H
...
namespace Server {
    ...
    public:
         ...
         */
        virtual HandlePtr registerCallback(Stage stage, StageCallback callback) = 0;
        virtual HandlePtr registerCallback(Stage stage, StageCallbackWithCompletion callback) =0;
    };

} // namespace Server

#endif //EVENTLOOP_BASE_SERVER_LIFECYCLENOTIFIER_H
