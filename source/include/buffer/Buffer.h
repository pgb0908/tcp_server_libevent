...
#ifndef LIBEVENT_TEST1_BUFFER_H
#define LIBEVENT_TEST1_BUFFER_H
 ...
 */
    ...
    public:
         ...
         */
        virtual absl::Span<uint8_t> getMutableData() = 0;
    };
 ...
 */
    ...
    public:
         ...
         */
        virtual void charge(uint64_t amount) = 0;
         ...
         */
        virtual void credit(uint64_t amount) = 0;
         ...
         */
        virtual void clearDownstream() = 0;
         ...
         */
        virtual void resetDownstream() = 0;
    };
 ...
 */
    ...
    public:
         ...
         * from all buffers.
         */
        virtual void addDrainTracker(std::function<void()> drain_tracker) = 0;
         ...
         */
        virtual void bindAccount(BufferMemoryAccountSharedPtr account) = 0;
         ...
         */
        virtual void add(const Instance& data) = 0;

        /**
         * Prepend a string_view to the buffer.
         * @param data supplies the string_view to copy.
         */
        virtual void prepend(absl::string_view data) = 0;
         ...
         * @param data supplies the buffer to copy.
         */
        virtual void prepend(Instance& data) = 0;
         ...
         */
        virtual SliceDataPtr extractMutableFrontSlice() = 0;
         ...
         */
        virtual void* linearize(uint32_t size) = 0;
         ...
         */
        virtual Reservation reserveForRead() = 0;
         ...
         */
        virtual ssize_t search(const void* data, uint64_t size, size_t start, size_t length) const = 0;
         ...
         */
        virtual bool startsWith(absl::string_view data) const = 0;
         ...
         */
        virtual size_t addFragments(absl::Span<const absl::string_view> fragments) = 0;
         ...
         */
        virtual void setWatermarks(uint32_t watermark, uint32_t overflow_multiplier = 0) = 0;

        /**
         * Returns the configured high watermark. A return value of 0 indicates that watermark
         * functionality is disabled.
         */
        virtual uint32_t highWatermark() const = 0;
        /**
         ...
         * the low watermark.
         */
        virtual bool highWatermarkTriggered() const = 0;
    ...
    private:
        ...
        virtual void commit(uint64_t length, absl::Span<RawSlice> slices,
                            ReservationSlicesOwnerPtr slices_owner) = 0;
    };
 ...
 */
    ...
    public:
        ...
        virtual InstancePtr createBuffer(std::function<void()> below_low_watermark,
                                         ...
                                         std::function<void()> above_overflow_watermark) = 0;
         ...
         */
        //virtual BufferMemoryAccountSharedPtr createAccount(Http::StreamResetHandler& reset_handler) = 0;
         ...
         */
        virtual uint64_t resetAccountsGivenPressure(float pressure) = 0;
    };
