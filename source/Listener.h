...
public:
     ...
     */
    //virtual UdpListenerWorkerRouter& listenerWorkerRouter(const Network::Address::Instance& address) = 0;
...
struct UdpRecvData {
    struct LocalPeerAddresses {
        ...
        InstanceConstSharedPtr local_;
        InstanceConstSharedPtr peer_;
    };
...
public:
     ...
     */
    //virtual void onReceiveError(IoErrorCode error_code) = 0;
     ...
     */
    virtual void onDataWorker(UdpRecvData&& data) = 0;

    /**
     * Posts ``data`` to be delivered on this worker.
     */
    virtual void post(UdpRecvData&& data) = 0;
 ...
 */
//class ListenerTypedMetadataFactory : public TypedMetadataFactory {};
